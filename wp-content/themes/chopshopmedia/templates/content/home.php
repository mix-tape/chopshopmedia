  ...
  <section class="wrapper" style="background-image: url(<?php image_directory() ?>/hero-home-temp.jpg)">

    <div class="container heroSection">

      <span class="heroTagline">

        Digital.<br>
        Film.<br>
        Design.<br>

        <hr class="separator heroTagline-separator">
    ...
    <div class="container">
      ...
      <div class="sectionSplit sectionSplit--large">
        ...
        <div class="sectionSplit-content">
          ...
          <p><strong>Chop Shop Media is a creative agency specialising in film & content and creative direction.</strong></p>
  ...
  <?php get_template_part( 'templates/layout/call-to-action' ); ?>
